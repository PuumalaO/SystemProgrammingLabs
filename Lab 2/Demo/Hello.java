class Hello implements ExampleThread.ExampleThreadReporterInterface
{
  ...
  public void soppOpen() {
    System.out.println("Sopp open");
  }
  public void soppClosed() {
    System.out.println("Sopp closed");
  }
